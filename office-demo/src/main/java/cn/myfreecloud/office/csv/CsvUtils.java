...
public class CsvUtils {
     ...
     * 写csv文件 (一次性写  数据不宜过大)
     */
    public static File writeCsv(List<Object> objectList, String[] fileHeader, String fileName) throws Exception {
     ...
     *
     **/
    public static <T> List<T> readCSV(String filePath, String[] headers, Class<T> tClass) throws Exception {
        //创建CSVFormat
    ...
    public static void main(String[] args) throws Exception {
        ...
        // List<String> m = CsvUtils.readCSV("D:\\Desktop\\radar\\sourceone.csv", fileHeader, String.class);
        List<String> m = CsvUtils.readCSV("d:\\workbook.csv", fileHeader, String.class);
        for (String string : m) {
