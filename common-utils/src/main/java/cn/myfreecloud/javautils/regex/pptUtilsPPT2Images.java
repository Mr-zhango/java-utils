...
public class pptUtilsPPT2Images {

    public static void main(String[] args) {
        List<String> result = converPPTtoImage("C:\\develop\\IDEAProjects\\MyProjects\\java-utils\\src\\main\\resources\\static\\file\\xp_o3.ppt", "C:\\Users\\zhangyang\\Desktop\\demo\\", "jpg", 2);
        for (String s : result) {
