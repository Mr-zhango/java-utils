...
public class pptxUtils {
    ...
    public static List<String> converPPTtoImage(String orignalPPTFileName, String targetImageFileDir,
        ...
        try {
            ...
            List<XSLFSlide> pptPageSlideList = oneHSLFSlideShow.getSlides();
            int i = 0;
            // 下面循环的主要功能是实现对PPT文件中的每一张幻灯片进行转换和操作
            for (XSLFSlide slide : pptPageSlideList) {
                ...
                for (XSLFShape shape : shapes) {
                    if (shape instanceof XSLFTextShape) {
                        ...
                        for (XSLFTextParagraph hslfTextParagraph : textParagraphs) {
                            List<XSLFTextRun> HSLFTextRunList = hslfTextParagraph.getTextRuns();
    ...
    public static void main(String[] args) {
        List<String> result = converPPTtoImage("C:\\develop\\IDEAProjects\\MyProjects\\java-utils\\src\\main\\resources\\static\\file\\2016测试pptx.pptx", "C:\\Users\\zhangyang\\Desktop\\demo\\", "jpg", 8);
        for (String s : result) {
